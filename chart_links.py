...
compare= に何を入れるかは推測せず、実際にブラウザで開いて確かめた（2026-09-13）。
  ・日本株 https://finance.yahoo.co.jp/quote/7011.T/chart?frm=dly&trm=6m&compare=998407.O%2C998405.T
      → 凡例が「7011.T ／ 日経平均 ／ TOPIX」の3本になる。指数は「,」でつなげば同時に重なる。
      日経平均=998407.O、TOPIX=998405.T（ページの比較チェックボックスを押して出たURLで確認）。
...
# 日経平均とTOPIX。URLでは「,」が %2C になる。
JP_COMPARE_CODES = "998407.O%2C998405.T"
JP_COMPARE_LABEL = "日経平均・TOPIXと比較"
